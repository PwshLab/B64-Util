...
[Text.encoding]::Unicode.GetString([convert]::FromBase64String($inject)) | Write-Output
("Convert-StringToB64", "Convert-StringFromB64", "Package-CompressedB64") | Format-Table
